# LeasyCloud Angular Dashboard App

## Summary

The Angular dashboard connects to the [Open LeasyCloud NodeJs Server](https://github.com/sap-labs-france/ev-server) to display the charging stations in real time.
